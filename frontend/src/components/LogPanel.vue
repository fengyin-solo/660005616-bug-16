...
.log-row.timeout{color:#d69e2e;background:#d69e2e10}.log-row.blocked{color:#a78bfa;background:#7c3aed10}
.log-row.circuit_open,.log-row.circuit_half_open{color:#f87171}
